...
function Header() {
    ...
    const createClerkPasskey = async () => {
        // Logic for creating a Clerk passkey
        try {
    ...
    return (
        <header className="w-full flex flex-wrap justify-between items-center px-4 py-2 bg-white shadow">
            {/* Top row */}
            <div className="flex w-full flex-wrap justify-between items-center max-w-7xl mx-auto">
                ...
                <div className="flex flex-wrap space-x-4 mt-4 sm:mt-0 flex-1 sm:flex-none">
                    <Link href="/basket"
